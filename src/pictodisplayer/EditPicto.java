 ...
 * @author Paweł
 */
public class EditPicto extends javax.swing.JFrame {

    private PagePanel handle;
    private Picto picto;

    /**
     * Creates new form nowaKategoria
     */
    public EditPicto(int pictoID) {
        picto = new Picto(pictoID);
        try {
        ...
        initComponents();
        this.name.setText(picto.name);
        this.sort.setText(picto.sort.toString());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Edycja Piktogramu"));
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        picto.name = this.name.getText();
        picto.sort = Integer.parseInt(this.sort.getText());
        picto.update();
        this.handle.reloadImages();
        this.setVisible(false);
     ...
     * @param handel
     */
    public void setPagePanel(PagePanel handle) {
        this.handle = handle;
    }
